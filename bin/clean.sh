...
echo ----------------------------------------------
echo    Command: pylint -vv "$SCRIPT_DIR/gen3analysis" --rcfile ~/.gen3/.github/linters/.python-lint
pylint -vv "$SCRIPT_DIR/gen3analysis" --rcfile ~/.gen3/.github/.github/linters/.python-lint
